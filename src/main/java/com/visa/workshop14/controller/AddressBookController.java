package com.visa.workshop14.controller;
...
import com.visa.workshop14.service.ContactsRedis;
...
public class AddressBookController {
    ...
    public String submitContact(@ModelAttribute Contact contact, Model model){
        ...
        Contact c = new Contact(contact.getName(), contact.getEmail(), contact.getPhoneNumber());
